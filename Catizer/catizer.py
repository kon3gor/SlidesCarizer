...
import pickle
from values import *
from utils import getPhotoNames, getSlideNames, calculateCoords, getId
...
def initSlides():
    ...
    service = build('slides', 'v1', developerKey="AIzaSyDs-qYo-n6u8xZFVVHoH9dHxL2JFaKmnZE", credentials=creds)
